    ...
    <div class="quiz-container">
        ...
        <div id="quiz">
            ...
            <div class="question-container" id="question-4">
                ...
                <div class="answer-buttons">
                    <button class="btn btn-outline-primary" onclick="nextQuestion(4)">Untuk menampilkan judul
                        gambar</button>
                    <button class="btn btn-outline-primary" onclick="nextQuestion(4)">Untuk memberikan deskripsi teks
                        jika gambar tidak bisa ditampilkan</button>
                    <button class="btn btn-outline-primary" onclick="nextQuestion(4)">Untuk menentukan ukuran
                        gambar</button>
                    <button class="btn btn-outline-primary" onclick="nextQuestion(4)">Untuk menentukan letak gambar di
                        halaman</button>
                </div>
            </div>
