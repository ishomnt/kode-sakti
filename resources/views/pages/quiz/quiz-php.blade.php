  ...
  <div class="quiz-container">
    ...
    <div id="quiz">
      ...
      <div class="question-container" id="question-3">
        ...
        <div class="answer-buttons">
          <button class="btn btn-outline-primary" onclick="nextQuestion(3)">Mengecek apakah sebuah variabel sudah diisi</button>
          ...
          <button class="btn btn-outline-primary" onclick="nextQuestion(3)">Menampilkan nilai sebuah variabel</button>
        </div>
      </div>
      ...
      <div class="question-container" id="question-4">
        ...
        <div class="answer-buttons">
          <button class="btn btn-outline-primary" onclick="nextQuestion(4)">&lt;!-- Ini adalah komentar --&gt;</button>
